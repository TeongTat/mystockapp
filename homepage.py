...
with tab1:
    ...
    st.write("""
    This app helps investors view historical S&P 500 stock trends and forecast prices using the ARIMA model.
    Now powered by **Twelve Data API**, which provides real-time market data.
    """)
